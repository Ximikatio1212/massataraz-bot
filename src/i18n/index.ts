...
const DICT: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    // ── консультант ──
    assistant_client_active: "💬 <b>Консультант активен.</b>\n\nСпросите меня о товарах, ценах, наличии или составе. Например:\n• «Что такое тестестерон?»\n• «Есть ли креатин и сколько стоит?»\n• «Подбери протеин до 30000 ₸»\n• «Проверь заказ №5»\n\nВернуться к меню — нажмите любую кнопку ниже или «💬 Вопрос консультанту» ещё раз.",
  ...
  kk: {
    ...
    // ── консультант ──
    assistant_client_active: "💬 <b>Кеңесші қосылды.</b>\n\nТауарлар, бағалар, қолда бар және құрам туралы сұраңыз. Мысалы:\n• «Тестестерон деген не?»\n• «Креатин бар ма, қанша тұрады?»\n• «30000 ₸ дейінгі протеин таңдап бер»\n• «№5 тапсырысты тексер»\n\nМәзірге қайту үшін төмендегі кез келген батырманы немесе «💬 Кеңесшіге сұрақ» түймесін қайта басыңыз.",
